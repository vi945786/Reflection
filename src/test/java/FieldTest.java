...
public class FieldTest {
    ...
    public void setPrivateStaticFinalField() {
        FieldReflection.setFieldValue(getField(FakeClass.class, "privateStaticFinalField"), FakeClass.class, 1);
    ...
    public void setPrivateStaticFinalFieldSuperclass() {
        FieldReflection.setFieldValue(getField(FakeClass2.class, "privateStaticFinalFieldSuperclass"), FakeClass2.class, 1);
